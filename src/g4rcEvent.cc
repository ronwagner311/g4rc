...
void g4rcEvent::ProduceNewParticle( G4ThreeVector pos, G4ThreeVector mom, G4String name ){
...
void g4rcEvent::UndoLastParticle(){
    fPartPos.pop_back();
    fPartMom.pop_back();
    fPartType.pop_back();
}

G4bool g4rcEvent::EventIsSane(){
